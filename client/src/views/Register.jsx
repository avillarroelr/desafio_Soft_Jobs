...
const Register = () => {
  ...
  const handleForm = (event) => {
    ...
    axios.post(ENDPOINT.users, { userJobs: user })
      .then(() => {
      ...
      .catch(({ response: { data } }) => {
        console.error(data);
        if (data.message === 'El correo ya existe en nuestros registros') {
          window.alert('El correo ya existe en nuestros registros 🙁.');
        } else {
